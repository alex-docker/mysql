...
- MySQL server has a user called *root* with a password called *root*
...
- __Username:__ *root* (you can change this, we will come to this later)
- __Password:__ *root* (you can change this, we will come to this later)
